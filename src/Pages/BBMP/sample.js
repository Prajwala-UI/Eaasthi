          ...
          <div className="container mt-5">
            ...
            <div className="card">
              <div className="card-header layout_btn_color">
                <h5 className="card-title" style={{ textAlign: 'center' }}>Release Table</h5>
              </div>
            ...
            {releaseData.length > 0 && (
              <div className="card">
                <div className="card-header layout_btn_color">
                  <h5 className="card-title" style={{ textAlign: 'center' }}>Yet to be release table</h5>
                </div>
                <div className="card-body">
                  <div className='row'>
            ...
            <div className="card mt-4">
              <div className="card-header layout_btn_color">
                <h5 className="card-title" style={{ textAlign: 'center' }}>Final API list</h5>
              </div>
              <div className="card-body">
                <DataTable
                  columns={[
